...
class StudentConv3x3(nn.Module):
    """Single 3x3 convolution used at every aligned student spatial position."""
...
class StudentLightEchoBlock(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        self.spatial_conv = StudentConv3x3(
            out_channels,
            out_channels,
            stride=stride,
            groups=out_channels,
...
class StudentLightEchoNet(nn.Module):
    """Compact student copied from the supplied CIFAR training notebook."""

    def __init__(self, num_classes: int = 10):
        super().__init__()
        self.input_norm = nn.BatchNorm2d(1)

        self.conv1 = StudentConv3x3(1, 16, stride=(2, 2))
        self.norm1 = nn.BatchNorm2d(16)
        self.activation1 = nn.ReLU()

        self.conv2 = StudentConv3x3(16, 32, stride=(2, 2))
        self.activation2 = nn.ReLU()

        self.stage1 = nn.Sequential(
            StudentLightEchoBlock(32, 32),
            StudentLightEchoBlock(32, 32),
            StudentLightEchoBlock(32, 32),
        )
